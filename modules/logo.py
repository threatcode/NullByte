...
==============================================={nc}''')
  ...
  def not_ins(self):
    self.tool_header()
    print (f'''
{cyan}  [ + ]  {red}We can't install NullByte.
...
{red} If you are installing this tool.
 that means you are agree with all terms.''')
  ...
  def ins_sc(self):
    self.tool_header()
    print (f'''
{yellow}    [ + ] {green}NullByte installed successfully.
{yellow}    [ + ] {green}To run NullByte,
{yellow}    [ + ] {green}Type NullByte in your terminal.''')
    self.tool_footer()
  ...
  def update(self):
    self.tool_header()
    print (f'''
{yellow}  [ 1 ] {green}Update your NullByte.
{yellow}  [ 0 ] {green}For Back.{nc}''')
  ...
  def updated(self):
    self.tool_header()
    print (f'''
{yellow}      [ + ] {green}NullByte Updated Successfully.
...
{cyan}  [ + ]  {red}Please try again after some time.{nc}''')
  ...
  def update_error(self):
    self.tool_header()
    print (f'''
{red}  [ + ]  {red}We can't Update NullByte.\033[1;m
...
{yellow}|  00) Back                                   |
 \033[01;36m============================================={nc}""")
  ...
  def updating(self):
    print (f"""{yellow} =============================================
{green}|______________ Updating NullByte ______________|
 {yellow}============================================={nc}""")
...
{yellow}  [ 3 ] {green}Update NullByte.
...
{yellow}  [ x ] {green}For Exit.''')
  ...
  def exit(self):
    self.tool_header()
    print (f'''
{yellow}         [ + ] {green}Thanks for using NullByte
